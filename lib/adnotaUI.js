...
window.AdnotaUI = {
  ...
  // container fallback and the sticky's Tier 2 container fallback. Returns
  // null when no inner scroller exists; the page itself is the scroll context,
  // and tier 3 (doc-pixel / percentage of scrollHeight) handles that case
  // correctly without needing a synthetic anchor.
